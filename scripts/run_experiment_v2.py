...
TEST_SOURCE = "gpt4o_v2"
CSV_PATH = os.path.join(BASE_DIR, "data", "full_ground_truth_v2.csv")
OUT_DIR = os.path.join(BASE_DIR, "generated_tests", TEST_SOURCE)
LOG_PATH = os.path.join(BASE_DIR, "results", "generation_log_v2.csv")
COST_LOG = os.path.join(BASE_DIR, "results", "api_log_v2.txt")
