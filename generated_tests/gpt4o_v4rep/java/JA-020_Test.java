...
public class HelpFormatterTest {
    ...
    public void testAppendOptionGroupWithOptionalGroup() throws Exception {
        ...
        assertEquals("[a" + getDefaultOptionGroupSeparator(instance) + "b]", buff.toString());
    }
    ...
    private String getDefaultOptionGroupSeparator(HelpFormatter instance) throws Exception {
        Field separatorField = HelpFormatter.class.getDeclaredField("DEFAULT_OPTION_GROUP_SEPARATOR");
        separatorField.setAccessible(true);
        return (String) separatorField.get(null);
    }
}