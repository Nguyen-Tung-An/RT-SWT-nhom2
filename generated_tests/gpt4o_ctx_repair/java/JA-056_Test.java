...
public class GsonTest {
    ...
    void testFromJson_ValidJson_ReturnsObject() throws Exception {
        ...
        Person person = gson.fromJson(new JsonReader(new StringReader(json)), typeToken.getType());
    ...
    void testFromJson_InvalidJson_ThrowsJsonSyntaxException() {
        ...
        assertThrows(JsonSyntaxException.class, () -> {
            gson.fromJson(new JsonReader(new StringReader(json)), typeToken.getType());
        });
    }
