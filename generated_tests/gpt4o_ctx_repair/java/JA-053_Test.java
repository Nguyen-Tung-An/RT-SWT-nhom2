...
public class CollectionUtilsTest {
    ...
    @Test
    void testSize_SetOperationCardinalityHelper() {
        Collection<Object> collectionA = Arrays.asList("element1", "element2");
        Collection<Object> collectionB = Arrays.asList("element2", "element3");
        CollectionUtils.SetOperationCardinalityHelper helper = new CollectionUtils.SetOperationCardinalityHelper(collectionA, collectionB);
