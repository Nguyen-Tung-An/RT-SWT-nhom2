...
public class AccurateMathTest {
    @Test
    void testCosh_NaN() {
        assertEquals(Double.NaN, AccurateMath.cosh(Double.NaN));
    }

    @Test
    void testCosh_PositiveLarge() {
        assertEquals(Double.POSITIVE_INFINITY, AccurateMath.cosh(21));
    }
