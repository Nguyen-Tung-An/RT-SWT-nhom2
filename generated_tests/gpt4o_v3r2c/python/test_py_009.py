...
class TestRunCommand:
    ...
    def test_run_command_success(self, mock_run_simple, app_info):
        ...
        mock_run_simple.assert_called_once_with(
            '127.0.0.1', 5000, app_info[0].load_app(), use_reloader=False, use_debugger=False, threaded=False, ssl_context=None, extra_files=None, exclude_patterns=None
        )
    ...
    def test_run_command_with_reload(self, mock_run_simple, app_info):
        ...
        mock_run_simple.assert_called_once_with(
            '127.0.0.1', 5000, app_info[0].load_app(), use_reloader=True, use_debugger=False, threaded=False, ssl_context=None, extra_files=None, exclude_patterns=None
        )
    ...
    def test_run_command_with_debugger(self, mock_run_simple, app_info):
        ...
        mock_run_simple.assert_called_once_with(
            '127.0.0.1', 5000, app_info[0].load_app(), use_reloader=False, use_debugger=True, threaded=False, ssl_context=None, extra_files=None, exclude_patterns=None
        )
    ...
    def test_run_command_with_ssl(self, mock_run_simple, app_info):
        ...
        mock_run_simple.assert_called_once_with(
            '127.0.0.1', 5000, app_info[0].load_app(), use_reloader=False, use_debugger=False, threaded=False, ssl_context=cert, extra_files=None, exclude_patterns=None
        )
    ...
    def test_run_command_with_extra_files(self, mock_run_simple, app_info):
        ...
        mock_run_simple.assert_called_once_with(
            '127.0.0.1', 5000, app_info[0].load_app(), use_reloader=False, use_debugger=False, threaded=False, ssl_context=None, extra_files=extra_files, exclude_patterns=None
        )
    ...
    def test_run_command_with_exclude_patterns(self, mock_run_simple, app_info):
        ...
        mock_run_simple.assert_called_once_with(
            '127.0.0.1', 5000, app_info[0].load_app(), use_reloader=False, use_debugger=False, threaded=False, ssl_context=None, extra_files=None, exclude_patterns=exclude_patterns
        )
    ...
    def test_run_command_with_none_reload_debugger(self, mock_run_simple, app_info, reload, debugger):
        ...
        mock_run_simple.assert_called_once_with(
            '127.0.0.1', 5000, app_info[0].load_app(), use_reloader=(reload if reload is not None else False), use_debugger=(debugger if debugger is not None else False), threaded=False, ssl_context=None, extra_files=None, exclude_patterns=None
        )