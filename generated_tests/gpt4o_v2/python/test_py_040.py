...
class TestValidateKey:
    @pytest.fixture
    def ctx(self):
        return click.Context(click.Command("test"), params={})

    def test_valid_key_with_cert(self, ctx):
        ctx.params["cert"] = "valid_cert"
        result = _validate_key(ctx, click.Parameter(name="key"), "valid_key")
    ...
    def test_valid_key_with_adhoc_cert(self, ctx):
        ...
        with pytest.raises(click.BadParameter) as excinfo:
            _validate_key(ctx, click.Parameter(name="key"), "valid_key")
