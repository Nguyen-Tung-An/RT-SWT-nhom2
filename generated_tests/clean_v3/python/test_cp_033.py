...
class TestSetEnviron:
    ...
    def test_set_environ_with_value(self):
        ...
        assert env_name not in os.environ  # Check that it is removed after context
    ...
    def test_set_environ_with_none(self):
        ...
        with set_environ(env_name, value):
            assert env_name not in os.environ  # Should not set anything
        
        assert env_name not in os.environ  # Check that it is still not set
    ...
    def test_set_environ_existing_value(self):
        ...
        assert os.environ[env_name] == original_value  # Check that original value is restored
    ...
    def test_set_environ_existing_value_none(self):
        ...
        assert os.environ[env_name] == original_value  # Check that original value is still there
