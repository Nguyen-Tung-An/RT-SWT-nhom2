...
public class ArrayUtilsTest {
    ...
    void testIndexOf_ArrayIsNull() {
        assertEquals(CollectionUtils.INDEX_NOT_FOUND, ArrayUtils.indexOf(null, "test", 0));
    }
    ...
    void testIndexOf_ObjectNotFound() {
        Object[] array = {"a", "b", "c"};
        assertEquals(CollectionUtils.INDEX_NOT_FOUND, ArrayUtils.indexOf(array, "d", 0));
    }
    ...
    void testIndexOf_StartIndexOutOfBounds() {
        Object[] array = {"a", "b", "c"};
        assertEquals(CollectionUtils.INDEX_NOT_FOUND, ArrayUtils.indexOf(array, "a", 5));
    }
}