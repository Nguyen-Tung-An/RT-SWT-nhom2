...
def test_resolve_proxies_with_environ_proxies():
    request = Request(url='http://example.com')
    proxies = {'http': 'http://proxy.com'}
    # Mocking the functions should_bypass_proxies and get_environ_proxies
...
def test_resolve_proxies_with_multiple_schemes():
    request = Request(url='https://example.com')
    proxies = {'http': 'http://proxy.com', 'https': 'https://secureproxy.com'}
    result = resolve_proxies(request, proxies)
    assert result == {'http': 'http://proxy.com', 'https': 'https://secureproxy.com'}