...
def test_raise_for_status_client_error_bytes():
    response = Response()
...
def test_raise_for_status_client_error_str():
    response = Response()
...
def test_raise_for_status_server_error_bytes():
    response = Response()
...
def test_raise_for_status_server_error_str():
    response = Response()
