...
public class StringUtilTest {
    ...
    @Test
    void testIsNumeric_OnlyDigits() {
        assertTrue(StringUtil.isNumeric("12345"));
    }

    @Test
    void testIsNumeric_LeadingSpaces() {
        assertFalse(StringUtil.isNumeric(" 12345"));
    }

    @Test
    void testIsNumeric_TrailingSpaces() {
        assertFalse(StringUtil.isNumeric("12345 "));
    }
    ...
    @Test
    void testIsNumeric_PositiveSign() {
        assertFalse(StringUtil.isNumeric("+123"));
    }

    @Test
    void testIsNumeric_FloatNumber() {
