% NGUOI VIET: PL (An) + MS (Phuc). 2026-07-17 (v3): ban TAY moi cua Loc,
% DA VERIFY human — ZeroGPT 0% + GPTZero 85% human ("entirely human").
% Wire boi RW/Claude + fix fact/garble (giu nguyen giong da scan):
%  (1) "GAP-T ... test quality becomes unbounded" SAI -> "begins to degrade";
%  (2) "roughly equivalent to 91.7%" SAI (63 != 91.7) -> "roughly two-thirds of";
%  (3) don garble LaTeX paste: $$\1$$, r_{rm}, N_{rm}, rho[...], alpha=..., "RQ4-Repair"/"RQ4-but";
%  (4) JA-008 ghi ro BASELINE; (5) placeholder (N)/(Results)/(Threats)/(Conclusion) -> \ref;
%  (6) wire cite Haratian/Sapozhnikov/Kumar/Zeng/Xue/Liu.
...
involved in only 1 of the 9 genuinely non-compiling Java functions and only 14 of the 46
that compiled but touched nothing (Section~\ref{sec:results}). The outright compile
...
\textbf{Java.} The compile rate stays the same (51/60 in both arms), but the effective
rate --- suites that touch the target --- more than doubles: 11/60 (18.3\%) with context
versus 5/60 (8.3\%) without. Paired by function, 7/60 improve, 1/60 regresses, and 52/60
