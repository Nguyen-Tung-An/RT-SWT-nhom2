...
| 2026-07-17 | 07_conclusion (ban tay v3) | **ZeroGPT + GPTZero** | **ZeroGPT 4.6% · GPTZero 100% Human ("entirely human")** | Human (detector dep nhat ca loat) | Wire ban tay moi + fix: "two iterations of repair (one manual)" SAI (RQ5 chi 1 vong, RQ4 la context; Python context NEUTRAL chi repair regress); "production code ... extensive reflection" claim khong can cu -> bo; r=-1.00 hieu dung (baseline thang moi cap). |
